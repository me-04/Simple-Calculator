...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button num0=findViewById(R.id.num0);    // 'R' is a class that contains all resource id's
        ...
        ArrayList<Button> nums=new ArrayList<>();   //arraylist will contain "button" object
        nums.add(num0);
        nums.add(num1);
        nums.add(num2);
        nums.add(num3);
